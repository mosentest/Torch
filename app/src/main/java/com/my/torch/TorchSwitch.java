...
public class TorchSwitch extends BroadcastReceiver {
    ...
    public static final String TOGGLE_FLASHLIGHT = "com.my.torch.TOGGLE_FLASHLIGHT";
    public static final String TORCH_STATE_CHANGED = "com.my.torch.TORCH_STATE_CHANGED";
