...
public class SettingsActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                mAlertDialog.setNegativeButton(getString(R.string.no), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        getPackageManager().setComponentEnabledSetting(new ComponentName("com.my.light", "com.my.light.LaunchActivity"), PackageManager.COMPONENT_ENABLED_STATE_ENABLED, PackageManager.DONT_KILL_APP);
                        dialog.dismiss();
                    }
                });
                mAlertDialog.setPositiveButton(getString(R.string.yes), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        getPackageManager().setComponentEnabledSetting(new ComponentName("com.my.light", "com.my.light.LaunchActivity"), PackageManager.COMPONENT_ENABLED_STATE_DISABLED, PackageManager.DONT_KILL_APP);
                        dialog.dismiss();
    ...
    public void onResume() {
        ...
        String mPrefColor = mPreferences.getString(KEY_COLOR, getString(R.string.yellow));
    ...
    private void openAboutDialog() {
        ...
        mMrDoomy.setColorFilter(getResources().getColor(R.color.yellowDark), PorterDuff.Mode.SRC_ATOP);
        mStudio.setColorFilter(getResources().getColor(R.color.yellow), PorterDuff.Mode.SRC_ATOP);
