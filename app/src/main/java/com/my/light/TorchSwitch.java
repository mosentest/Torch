...
public class TorchSwitch extends BroadcastReceiver {
    ...
    public static final String TOGGLE_FLASHLIGHT = "com.my.light.TOGGLE_FLASHLIGHT";
    public static final String TORCH_STATE_CHANGED = "com.my.light.TORCH_STATE_CHANGED";
